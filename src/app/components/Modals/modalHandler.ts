...
type ModalHashTable<T extends object> = { [P in ModalTypes | number | string]: IModal<T> };
 ...
 * @returns
 */
export function showModalById<T extends object>(id: string | number, params?: T) {
  if (!globalModals[id]) {
    console.warn(
 ...
 * @returns
 */
export function showModalByType<T extends object>(type: ModalTypes, params?: T) {
